(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-fullscreen__slider")) new core(".main-fullscreen__slider", {
            ...
            pagination: {
                el: ".main-fullscreen__swiper-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".swiper-button-prev",
        ...
        if (document.querySelector(".participation__slider--one")) new core(".participation__slider--one", {
            modules: [ Navigation, Pagination, EffectFade, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            pagination: {
                el: ".participation__swiper-pagination--one",
                clickable: true
            },
            navigation: {
                prevEl: ".swiper-button-prev",
        ...
        if (document.querySelector(".participation__slider--two")) new core(".participation__slider--two", {
            modules: [ Navigation, Pagination, EffectFade, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            pagination: {
                el: ".participation__swiper-pagination--two",
                clickable: true
            },
            navigation: {
                prevEl: ".swiper-button-prev",
        ...
        if (document.querySelector(".exhibition__slider")) new core(".exhibition__slider", {
            ...
            pagination: {
                el: ".exhibition__swiper-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".swiper-button-prev",
